...
const About = () => {
  return (
    <div className="min-h-screen bg-black/40 text-white flex flex-col py-10 text-center items-center justify-center px-6">
      ...
      <div className="mt-8">
        ...
        <p className="text-gray-300 mt-2">Locksy was built with ❤️ by Honey, with the vision to make password management effortless and secure for everyone.</p>
      </div>
    </div>
  );
};
